...
(function ($) {
    ...
    $.fn.makeEditable = function (options) {
        ...
        function fnApplyEditable(aoNodes) {
            ...
            var oDefaultEditableSettings = {
                ...
                "onsubmit": function (settings, original) {
                    ...
                    if(settings.type == "text" || settings.type == "select" || settings.type == "textarea" || settings.type == "datetimepicker" || settings.type == "autocomplete" )	/*ARVH*/
                    {
                        var input = $("input,select,textarea", this);
                        sNewCellValue = $("input,select,textarea", $(this)).val();
                        if (input.length == 1) {
                            var oEditElement = input[0];console.log( oEditElement.nodeName.toLowerCase() );
                ...
                "submitdata": function (value, settings) {	/* ARVH */
                    //iDisplayStart = fnGetDisplayStart();
                    //properties.fnStartProcessingMode();
        ...
        function _fnOnRowDeleteInline(e) {
            ...
            var id = fnGetCellID(nSelectedCell);	/* ARVH */
